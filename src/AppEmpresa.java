...
public class AppEmpresa {
    public static void main(String[] args) throws Exception {
        ...
        for(int emp = 0; emp < cantidad; emp++) {
            ...
            String cargo = JOptionPane.showInputDialog(null, "Ingrese el cargo el empleado");
            ...
            // Nombre y salarios de cada empleado
            ...
            // Total de dinero pagado por el total de los empleados
            for(int i = 0; i < cantidad; i++) {
